...
Mặc dù mô hình được tác giả Liang đề xuất ở bài báo \cite{mvae} không phải là mô hình đạt được kết quả tốt nhất hiện nay trong việc xây dựng hệ thống gợi ý sản phẩm, tuy nhiên kiến thức nền tảng để xây dựng mô hình này bao phủ về lĩnh vực học máy cũng như là kiến thức về mô hình xác suất. Đó là lý do chúng tôi quyết định sẽ tập trung tìm hiểu mô hình này trong khóa luận.
