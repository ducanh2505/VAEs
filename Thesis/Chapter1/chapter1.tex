...
nếu kết quả trả về là điểm số được dự đoán của người dùng cho tập các sản phẩm 
hoặc có thể là một bài toán xếp hạng (``top-N ranking'') nếu ta cần kết quả trả về 
...
hoặc khi một sản phẩm được ít người dùng tương tác, hệ thống thường có xu hướng không gợi ý sản phẩm đó.
