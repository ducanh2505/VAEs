...
Ở đây, trong bài toán xây dựng hệ thống gợi ý sản phẩm thì, dữ liệu tương tác của người dùng sẽ được xem là dữ liệu quan sát được và đặc trưng ẩn là ``dữ liệu ẩn'' mà ta không quan sát được. 
...
Với những lợi điểm như trên, thì chúng tôi đã quyết định sẽ tập trung tìm hiểu model được đề xuất ở bài báo \cite{mvae}. 
