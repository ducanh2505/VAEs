...
\section{Mở rộng mô hình ``Variational Auto-encoder'' cho bài toán gợi ý sản phẩm}
    ...
    Dữ liệu lương tác trong hệ thống gợi ý sản phẩm thường là dữ liệu thưa, có nghĩa là các phần tử trong véc-tơ input đầu vào sẽ đa phần sẽ mang giá trị 0 thể hiện cho ý nghĩa về mặt xác suất. 
